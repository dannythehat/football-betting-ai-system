...
def train_corners_model(data_path: str = None):
    """Train Corners model using shared training pipeline"""
    if data_path is None:
        data_path = str(TRAINING_DATA_PATHS['corners'])
    
    print("\n" + "=" * 60)
    print("TRAINING CORNERS OVER 9.5 MODEL")
    print("=" * 60)
